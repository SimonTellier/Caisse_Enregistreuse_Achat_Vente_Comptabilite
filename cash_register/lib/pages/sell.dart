...
List<Choice> choices = <Choice>[
  Choice(
      id: 0,
      title: 'Grosse Boule T80',
      prix: 4.5,
      icon: 'assets/icons/bread.svg'),
  Choice(
      id: 1,
      title: 'Pain de mie T80',
      prix: 4.5,
      icon: 'assets/icons/pain_de_mie.svg'),
  Choice(
      id: 2,
      title: 'Grosse Boule T150',
      prix: 4.5,
      icon: 'assets/icons/bread.svg'),
  Choice(
      id: 3,
      title: 'Tourte de Seigle',
      prix: 3.5,
      icon: 'assets/icons/bread.svg'),
];
                            ...
                            child: Center(
                              child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                      choices[index].prix.toStringAsFixed(2) +
                                          "€",
                                      textAlign: TextAlign.center,
                                    ),
                                  ]),
